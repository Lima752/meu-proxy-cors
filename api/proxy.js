...
// VERSÃO FINAL - Usando as credenciais fornecidas pelo usuário
...
module.exports = async (request, response) => {
    ...
    console.log("--- INICIANDO REQUISIÇÃO (Credenciais Fornecidas) ---");
    ...
    try {
        ...
        const secret = "2cabe1ab28674f1f9b10876baf22e94f"; // Usando o secret fornecido
        // ===========================================
